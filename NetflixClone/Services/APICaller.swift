...
class APICaller {
    ...
    func getTrendingMovies(completion: @escaping (MoviesResponse?) -> Void) {
    ...
    func getTrendingTvs(completion: @escaping (TrendingTvResponse?) -> Void) {
        networkDataFetcher.fetchGenericJSONData(
    ...
    func getPopularMovies(completion: @escaping (MoviesResponse?) -> Void) {
        networkDataFetcher.fetchGenericJSONData(
    ...
    func getUpcomingMovies(completion: @escaping (MoviesResponse?) -> Void) {
        networkDataFetcher.fetchGenericJSONData(
    ...
    func getTopRatedMovies(completion: @escaping (MoviesResponse?) -> Void) {
        networkDataFetcher.fetchGenericJSONData(
